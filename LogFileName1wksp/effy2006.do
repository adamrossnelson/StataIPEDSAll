...
*                                                        
// insheet using "c:\dct\effy2006_data_stata.csv", comma clear
label data "dct_effy2006"
...
label define label_xfyrac01 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac01 51 "Outlier value derived from imported data", add 
label define label_xfyrac01 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac01 53 "Value not derived - data not usable", add 
...
label define label_xfyrac02 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac02 51 "Outlier value derived from imported data", add 
label define label_xfyrac02 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac02 53 "Value not derived - data not usable", add 
...
label define label_xfyrac03 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac03 51 "Outlier value derived from imported data", add 
label define label_xfyrac03 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac03 53 "Value not derived - data not usable", add 
...
label define label_xfyrac04 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac04 51 "Outlier value derived from imported data", add 
label define label_xfyrac04 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac04 53 "Value not derived - data not usable", add 
...
label define label_xfyrac05 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac05 51 "Outlier value derived from imported data", add 
label define label_xfyrac05 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac05 53 "Value not derived - data not usable", add 
...
label define label_xfyrac06 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac06 51 "Outlier value derived from imported data", add 
label define label_xfyrac06 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac06 53 "Value not derived - data not usable", add 
...
label define label_xfyrac07 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac07 51 "Outlier value derived from imported data", add 
label define label_xfyrac07 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac07 53 "Value not derived - data not usable", add 
...
label define label_xfyrac08 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac08 51 "Outlier value derived from imported data", add 
label define label_xfyrac08 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac08 53 "Value not derived - data not usable", add 
...
label define label_xfyrac09 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac09 51 "Outlier value derived from imported data", add 
label define label_xfyrac09 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac09 53 "Value not derived - data not usable", add 
...
label define label_xfyrac10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac10 51 "Outlier value derived from imported data", add 
label define label_xfyrac10 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac10 53 "Value not derived - data not usable", add 
...
label define label_xfyrac11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac11 51 "Outlier value derived from imported data", add 
label define label_xfyrac11 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac11 53 "Value not derived - data not usable", add 
...
label define label_xfyrac12 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac12 51 "Outlier value derived from imported data", add 
label define label_xfyrac12 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac12 53 "Value not derived - data not usable", add 
...
label define label_xfyrac13 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac13 51 "Outlier value derived from imported data", add 
label define label_xfyrac13 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac13 53 "Value not derived - data not usable", add 
...
label define label_xfyrac14 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac14 51 "Outlier value derived from imported data", add 
label define label_xfyrac14 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac14 53 "Value not derived - data not usable", add 
...
label define label_xfyrac15 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac15 51 "Outlier value derived from imported data", add 
label define label_xfyrac15 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac15 53 "Value not derived - data not usable", add 
...
label define label_xfyrac16 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac16 51 "Outlier value derived from imported data", add 
label define label_xfyrac16 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac16 53 "Value not derived - data not usable", add 
...
label define label_xfyrac17 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac17 51 "Outlier value derived from imported data", add 
label define label_xfyrac17 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac17 53 "Value not derived - data not usable", add 
...
label define label_xfyrac18 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac18 51 "Outlier value derived from imported data", add 
label define label_xfyrac18 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac18 53 "Value not derived - data not usable", add 
...
label define label_xfyrac19 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac19 51 "Outlier value derived from imported data", add 
label define label_xfyrac19 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac19 53 "Value not derived - data not usable", add 
...
label define label_xfyrac20 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac20 51 "Outlier value derived from imported data", add 
label define label_xfyrac20 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac20 53 "Value not derived - data not usable", add 
...
label define label_xfyrac21 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac21 51 "Outlier value derived from imported data", add 
label define label_xfyrac21 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac21 53 "Value not derived - data not usable", add 
...
label define label_xfyrac22 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac22 51 "Outlier value derived from imported data", add 
label define label_xfyrac22 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac22 53 "Value not derived - data not usable", add 
...
label define label_xfyrac23 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac23 51 "Outlier value derived from imported data", add 
label define label_xfyrac23 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac23 53 "Value not derived - data not usable", add 
...
label define label_xfyrac24 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfyrac24 51 "Outlier value derived from imported data", add 
label define label_xfyrac24 52 "Value not derived - parent/child differs across components", add 
label define label_xfyrac24 53 "Value not derived - data not usable", add 
