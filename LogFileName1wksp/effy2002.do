...
*                                                        
// insheet using "c:\dct\effy2002_data_stata.csv", comma clear
label data "dct_effy2002"
...
label variable xfyrac05 "Imputation field for FYRACE05 - American Indian/Alaska Native men"
label variable fyrace05 "American Indian/Alaska Native men"
label variable xfyrac06 "Imputation field for FYRACE06 - American Indian/Alaska Native women"
label variable fyrace06 "American Indian/Alaska Native women"
...
label variable xfyrac15 "Imputation field for FYRACE15 - Total men"
label variable fyrace15 "Total men"
label variable xfyrac16 "Imputation field for FYRACE16 - Total women"
label variable fyrace16 "Total women"
...
label variable xfyrac19 "Imputation field for FYRACE19 - American Indian/Alaska Native total"
label variable fyrace19 "American Indian/Alaska Native total"
...
label define label_xfyrac18 23 "Partial imputation", add 
...
label define label_xfyrac18 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac19 23 "Partial imputation", add 
...
label define label_xfyrac19 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac20 23 "Partial imputation", add 
...
label define label_xfyrac20 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac21 23 "Partial imputation", add 
...
label define label_xfyrac21 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac22 23 "Partial imputation", add 
...
label define label_xfyrac22 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac23 23 "Partial imputation", add 
...
label define label_xfyrac23 40 "Suppressed to protect confidentiality", add 
...
label define label_xfyrac24 23 "Partial imputation", add 
...
label define label_xfyrac24 40 "Suppressed to protect confidentiality", add 
