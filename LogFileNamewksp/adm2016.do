...
*
// insheet using "C:\DCT\adm2016_data_stata.csv", comma clear
label data "dct_adm2016"
...
label define label_admcon1 5 "Considered but not required",add
...
label define label_admcon2 5 "Considered but not required",add
...
label define label_admcon3 5 "Considered but not required",add
...
label define label_admcon4 5 "Considered but not required",add
...
label define label_admcon5 5 "Considered but not required",add
...
label define label_admcon6 5 "Considered but not required",add
...
label define label_admcon7 5 "Considered but not required",add
...
label define label_admcon8 5 "Considered but not required",add
...
label define label_admcon9 9 " "
label define label_admcon9 1 "Required",add
label define label_admcon9 5 "Considered but not required",add
